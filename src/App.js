...
const LISTINGS = [
  {id:1,uid:10,name:"Nia Kendrick",ini:"NK",avc:ac(0),type:"service",cat:"Beauty & Wellness",sub:"Hair braiding & locs",title:"Knotless braids, locs & protective styles",desc:"10+ yrs. Home studio (Atlanta) or mobile. All textures, all ages welcome.",rate:85,loc:"Atlanta, GA",remote:false,verified:true,elite:true,b2b:false,score:97,swaps:87,rating:4.9,rev:87,saved:[],wants:["Creative & Design","Food & Farming","Goods & Resale"],platforms:[{id:"styleseat",l:"StyleSeat",proof:"87 clients · 4.9★",url:"styleseat.com/niakendrick"},{id:"instagram",l:"Instagram",proof:"4.2k followers",url:"instagram.com/niakendrick.hair"},{id:"google",l:"Google Business",proof:"61 reviews · 5.0★",url:"g.co/niasnatural"}],certs:[],taxBracket:"$44k–$95k"},
  {id:2,uid:11,name:"Marcus Rivera",ini:"MR",avc:ac(1),type:"service",cat:"Home & Trade Services",sub:"Interior & exterior painting",title:"Residential & commercial painting — licensed & insured",desc:"15 yrs, licensed contractor. Free estimate. Coachella Valley & Palm Desert.",rate:95,loc:"Palm Desert, CA",remote:false,verified:true,elite:true,b2b:true,score:94,swaps:61,rating:5.0,rev:61,saved:[],wants:["Creative & Design","Auto & Transportation","Tech & Digital"],platforms:[{id:"google",l:"Google Business",proof:"61 reviews · 5.0★",url:"maps.google.com/marcus"},{id:"thumbtack",l:"Thumbtack",proof:"Top Pro",url:"thumbtack.com/marcus"},{id:"angi",l:"Angi",proof:"Super Service Award",url:"angi.com/marcus"}],certs:["Business License","General Liability Insurance","Contractor License","Bonded & Insured"],taxBracket:"$95k–$201k"},
  {id:3,uid:12,name:"Deja Johnson",ini:"DJ",avc:ac(2),type:"goods",cat:"Food & Farming",sub:"Sourdough bread & baking",title:"Artisan sourdough, custom cakes & baked goods",desc:"Small-batch, all-natural. Custom orders. Delivery or pickup in Houston.",rate:55,loc:"Houston, TX",remote:false,verified:true,elite:false,b2b:false,score:88,swaps:34,rating:4.8,rev:340,saved:[],wants:["Creative & Design","Beauty & Wellness","Goods & Resale"],platforms:[{id:"etsy",l:"Etsy",proof:"340 sales · 4.8★",url:"etsy.com/shop/deja"},{id:"instagram",l:"Instagram",proof:"2.1k followers",url:"instagram.com/dejabakes"}],certs:[],taxBracket:"$0–$44k"},
  {id:4,uid:13,name:"Keanu Williams",ini:"KW",avc:ac(3),type:"service",cat:"Tech & Digital",sub:"Web development",title:"Shopify, Next.js & full-stack web apps",desc:"$40k+ Upwork earnings. Mobile-first. Small business specialist. 100% remote.",rate:100,loc:"Remote",remote:true,verified:true,elite:true,b2b:true,score:96,swaps:52,rating:4.9,rev:47,saved:[],wants:["Creative & Design","Professional & B2B","Talent & Ventures"],platforms:[{id:"upwork",l:"Upwork",proof:"$40k+ earned · 4.9★",url:"upwork.com/keanu"},{id:"linkedin",l:"LinkedIn",proof:"6yrs verified",url:"linkedin.com/in/keanu"}],certs:["Business License","LLC / Corporation Status"],taxBracket:"$95k–$201k"},
  {id:5,uid:14,name:"Trina Powell",ini:"TP",avc:ac(4),type:"service",cat:"Creative & Design",sub:"Graphic design",title:"Brand identity, flyers & social media kits",desc:"Adobe + Canva Pro. 24hr turnaround. Fiverr Level 2 seller. 5 yrs freelancing.",rate:65,loc:"Los Angeles, CA",remote:true,verified:true,elite:false,b2b:false,score:82,swaps:28,rating:4.7,rev:92,saved:[],wants:["Food & Farming","Tech & Digital","Beauty & Wellness"],platforms:[{id:"fiverr",l:"Fiverr",proof:"Level 2 · 4.7★",url:"fiverr.com/trinadesigns"},{id:"instagram",l:"Instagram",proof:"1.8k followers",url:"instagram.com/trinadesigns"}],certs:[],taxBracket:"$0–$44k"},
  {id:6,uid:15,name:"Lena Moore",ini:"LM",avc:ac(5),type:"service",cat:"Beauty & Wellness",sub:"Yoga & breathwork",title:"Private yoga, breathwork & mobility sessions",desc:"200-hr YTT certified. In-home, studio or virtual. All levels. Chicago area.",rate:75,loc:"Chicago, IL",remote:true,verified:true,elite:false,b2b:false,score:91,swaps:41,rating:4.9,rev:200,saved:[],wants:["Tech & Digital","Health & Medical","Food & Farming"],platforms:[{id:"mindbody",l:"Mindbody",proof:"200+ sessions · 4.9★",url:"mindbody.io/lena"},{id:"instagram",l:"Instagram",proof:"3.4k followers",url:"instagram.com/lenayoga"}],certs:[],taxBracket:"$44k–$95k"},
  {id:7,uid:16,name:"Carmen Osei",ini:"CO",avc:ac(6),type:"service",cat:"Events & Celebrations",sub:"Wedding planning",title:"Full-service wedding & event planning",desc:"100+ events. Licensed business. Day-of coordination to full planning packages.",rate:110,loc:"Atlanta, GA",remote:false,verified:true,elite:true,b2b:true,score:93,swaps:29,rating:5.0,rev:45,saved:[],wants:["Creative & Design","Beauty & Wellness","Food & Farming"],platforms:[{id:"google",l:"Google Business",proof:"45 reviews · 5.0★",url:"g.co/carmenevents"},{id:"instagram",l:"Instagram",proof:"8.1k followers",url:"instagram.com/carmenevents"},{id:"yelp",l:"Yelp",proof:"38 reviews · 4.9★",url:"yelp.com/carmen"}],certs:["Business License","General Liability Insurance","LLC / Corporation Status"],taxBracket:"$95k–$201k"},
  {id:8,uid:17,name:"Rico Farms",ini:"RF",avc:ac(7),type:"goods",cat:"Food & Farming",sub:"Farm eggs, milk & dairy",title:"Fresh farm eggs, raw honey, seasonal produce",desc:"Pasture-raised. Weekly harvest boxes. Local delivery or swap. Black-owned farm.",rate:40,loc:"Memphis, TN",remote:false,verified:true,elite:false,b2b:true,score:85,swaps:19,rating:4.8,rev:31,saved:[],wants:["Home & Trade Services","Auto & Transportation","Goods & Resale"],platforms:[{id:"etsy",l:"Etsy",proof:"Sells online",url:"etsy.com/ricofarms"},{id:"instagram",l:"Instagram",proof:"5.2k followers",url:"instagram.com/ricofarms"}],certs:["Business License","Health Dept Permit","Food Handler Cert"],taxBracket:"$44k–$95k"},
  {id:9,uid:18,name:"The Gutter Squad",ini:"GS",avc:ac(0),type:"squad",cat:"Community Squads",sub:"Friend group rotation (gutters, repairs)",title:"8-person rotation squad — gutters, caulking, repairs",desc:"We rotate homes every other weekend tackling jobs folks can't get to alone. Join or invite your crew.",rate:0,loc:"Dallas, TX",remote:false,verified:true,elite:false,b2b:false,score:89,swaps:44,rating:4.9,rev:44,saved:[],isSquad:true,wants:["Food & Farming","Care & Support"],platforms:[{id:"instagram",l:"Instagram",proof:"Community group · 1.1k",url:"instagram.com/guttersquad"}],certs:[],taxBracket:"$0–$44k"},
  {id:10,uid:19,name:"Alexis Gray CNA",ini:"AG",avc:ac(1),type:"service",cat:"Care & Support",sub:"Elder care (CNA)",title:"Certified nursing assistant — elder care & companionship",desc:"CNA licensed. In-home elder care, post-surgery support, companion visits. Background checked.",rate:35,loc:"Phoenix, AZ",remote:false,verified:true,elite:false,b2b:false,score:90,swaps:22,rating:5.0,rev:22,saved:[],wants:["Beauty & Wellness","Food & Farming","Home & Trade Services"],platforms:[{id:"linkedin",l:"LinkedIn",proof:"CNA License verified",url:"linkedin.com/alexisgray"},{id:"google",l:"Google Business",proof:"22 reviews · 5.0★",url:"g.co/alexiscares"}],certs:["Professional License (state)"],taxBracket:"$0–$44k"},
  {id:11,uid:20,name:"Braid & Books Academy",ini:"BB",avc:ac(2),type:"service",cat:"Lessons & Coaching",sub:"Music lessons (all instruments)",title:"Guitar, piano, voice & music theory lessons",desc:"10+ yrs teaching. Online or in-person. Kids & adults. First lesson free with any swap.",rate:70,loc:"Remote",remote:true,verified:true,elite:false,b2b:false,score:84,swaps:33,rating:4.8,rev:60,saved:[],wants:["Tech & Digital","Creative & Design"],platforms:[{id:"youtube",l:"YouTube",proof:"8.2k subscribers",url:"youtube.com/braidbooks"},{id:"instagram",l:"Instagram",proof:"2.3k followers",url:"instagram.com/braidbooks"}],certs:[],taxBracket:"$44k–$95k"},
  {id:12,uid:21,name:"Swift Auto Detail",ini:"SA",avc:ac(3),type:"service",cat:"Auto & Transportation",sub:"Car detailing",title:"Mobile car detailing — full interior & exterior",desc:"We come to you. Full detail in 3hrs. Licensed mobile business. Dallas metro.",rate:80,loc:"Dallas, TX",remote:false,verified:true,elite:false,b2b:true,score:87,swaps:38,rating:4.9,rev:55,saved:[],wants:["Home & Trade Services","Creative & Design","Tech & Digital"],platforms:[{id:"google",l:"Google Business",proof:"55 reviews · 4.9★",url:"g.co/swiftauto"},{id:"yelp",l:"Yelp",proof:"42 reviews",url:"yelp.com/swiftauto"}],certs:["Business License","General Liability Insurance"],taxBracket:"$44k–$95k"},
  {id:13,uid:22,name:"Tara Brooks",ini:"TB",avc:ac(4),type:"goods",cat:"Goods & Resale",sub:"Furniture & home decor",title:"Mid-century couch + dining set — trade for ?",desc:"Solid wood, great shape. Downsizing. Open to home services, art, or fair-value goods.",rate:60,loc:"Austin, TX",remote:false,verified:true,elite:false,b2b:false,score:81,swaps:12,rating:4.7,rev:18,saved:[],wants:["Home & Trade Services","Creative & Design","Auto & Transportation"],platforms:[{id:"poshmark",l:"Poshmark",proof:"Reseller · 4.8★",url:"poshmark.com/tara"},{id:"ebay",l:"eBay",proof:"120 sales · 99%",url:"ebay.com/usr/tarab"}],certs:[],taxBracket:"$0–$44k"},
  {id:14,uid:23,name:"Devon Pratt",ini:"DP",avc:ac(5),type:"rental",cat:"Rentals & Lending",sub:"Tools & power equipment",title:"Pressure washer, drills & power tools — weekend rental",desc:"Lend my gear, you keep your cash. Deposit via escrow. Pickup in Sacramento.",rate:25,loc:"Sacramento, CA",remote:false,verified:true,elite:false,b2b:false,score:79,swaps:27,rating:4.9,rev:30,saved:[],wants:["Garden & Outdoor","Auto & Transportation","Food & Farming"],platforms:[{id:"taskrabbit",l:"TaskRabbit",proof:"Elite Tasker",url:"taskrabbit.com/devon"},{id:"google",l:"Google Business",proof:"30 reviews · 4.9★",url:"g.co/devontools"}],certs:[],taxBracket:"$0–$44k"},
  {id:15,uid:24,name:"Imani Cole",ini:"IC",avc:ac(6),type:"digital",cat:"Digital & Virtual",sub:"Templates & presets",title:"Pitch deck, Notion systems & brand templates",desc:"Plug-and-play digital products. Instant delivery. Trade for dev, content, or coaching.",rate:50,loc:"Remote",remote:true,verified:true,elite:false,b2b:false,score:86,swaps:41,rating:4.8,rev:210,saved:[],wants:["Tech & Digital","Talent & Ventures","Creative & Design"],platforms:[{id:"etsy",l:"Etsy",proof:"210 sales · 4.8★",url:"etsy.com/imanitemplates"},{id:"github",l:"GitHub",proof:"Open-source templates",url:"github.com/imani"}],certs:[],taxBracket:"$44k–$95k"},
  {id:16,uid:25,name:"Andre Solis",ini:"AS",avc:ac(7),type:"venture",cat:"Talent & Ventures",sub:"Technical co-founder / CTO",title:"Technical co-founder / fractional CTO — equity or swap",desc:"Ex-FAANG eng. I'll build your MVP for equity, or swap engineering for biz/ops/legal help. Let's build.",rate:150,loc:"Remote",remote:true,verified:true,elite:true,b2b:true,score:95,swaps:9,rating:5.0,rev:9,saved:[],wants:["Professional & B2B","Talent & Ventures","Creative & Design"],platforms:[{id:"linkedin",l:"LinkedIn",proof:"Verified · 10yr eng",url:"linkedin.com/in/andresolis"},{id:"github",l:"GitHub",proof:"3.1k stars",url:"github.com/asolis"},{id:"crunchbase",l:"Crunchbase",proof:"2 prior exits",url:"crunchbase.com/andre"}],certs:["LLC / Corporation Status","Professional License (state)"],taxBracket:"$201k–$383k"},
  {id:17,uid:26,name:"Maya Reuben",ini:"MY",avc:ac(0),type:"venture",cat:"Talent & Ventures",sub:"Investor pitch coaching",title:"Investor pitch & presentation coaching",desc:"Coached founders into YC & seed rounds. I'll polish your deck & delivery — swap for design, dev, or content.",rate:120,loc:"New York, NY",remote:true,verified:true,elite:true,b2b:true,score:92,swaps:14,rating:5.0,rev:21,saved:[],wants:["Creative & Design","Tech & Digital","Digital & Virtual"],platforms:[{id:"linkedin",l:"LinkedIn",proof:"Verified · ex-VC",url:"linkedin.com/in/mayareuben"},{id:"crunchbase",l:"Crunchbase",proof:"Advisor · 8 startups",url:"crunchbase.com/maya"}],certs:["Business License","LLC / Corporation Status"],taxBracket:"$201k–$383k"},
  {id:18,uid:27,name:"Cole Whitfeather",ini:"CW",avc:ac(1),type:"experience",cat:"Survival & Preparedness",sub:"Wilderness survival & bushcraft",title:"2-day wilderness survival & bushcraft intensive",desc:"Fire, shelter, water, foraging. Small groups in the Rockies. Trade for gear, food, or skills.",rate:90,loc:"Denver, CO",remote:false,verified:true,elite:false,b2b:false,score:88,swaps:17,rating:4.9,rev:23,saved:[],wants:["Food & Farming","Goods & Resale","Health & Medical"],platforms:[{id:"youtube",l:"YouTube",proof:"22k subscribers",url:"youtube.com/colewild"},{id:"instagram",l:"Instagram",proof:"9.4k followers",url:"instagram.com/colewild"}],certs:[],taxBracket:"$44k–$95k"},
  {id:19,uid:28,name:"Renee Adler RN",ini:"RA",avc:ac(2),type:"experience",cat:"Survival & Preparedness",sub:"First aid & CPR training",title:"CPR, first aid & home emergency prep training",desc:"ER nurse. Certify your family or team. In-home or virtual. Swap for wellness, food, or home help.",rate:65,loc:"Seattle, WA",remote:true,verified:true,elite:false,b2b:false,score:90,swaps:26,rating:5.0,rev:33,saved:[],wants:["Beauty & Wellness","Home & Trade Services","Food & Farming"],platforms:[{id:"linkedin",l:"LinkedIn",proof:"RN License verified",url:"linkedin.com/reneeadler"}],certs:["Medical License","Professional License (state)"],taxBracket:"$44k–$95k"},
  {id:20,uid:29,name:"Gloria Hayes",ini:"GH",avc:ac(3),type:"aid",cat:"Mutual Aid & Community",sub:"Rides & transportation help",title:"Need rides to dialysis 2×/week — I'll cook for you",desc:"Recovering, no car right now. I'm a great cook & will trade home meals or sewing for a lift. Tulsa southside.",rate:0,loc:"Tulsa, OK",remote:false,verified:true,elite:false,b2b:false,score:83,swaps:6,rating:5.0,rev:6,saved:[],isSquad:false,wants:["Auto & Transportation","Care & Support"],platforms:[{id:"google",l:"Google Business",proof:"Community verified",url:"g.co/gloriahayes"}],certs:[],taxBracket:"$0–$44k"},
  {id:21,uid:30,name:"Northside Movers Circle",ini:"NM",avc:ac(4),type:"aid",cat:"Mutual Aid & Community",sub:"Moving & heavy lifting",title:"Moving help circle — borrow our muscle, bring pizza",desc:"Neighbors helping neighbors move. No cash — just pay it forward & feed the crew. Join the circle.",rate:0,loc:"Minneapolis, MN",remote:false,verified:true,elite:false,b2b:false,score:87,swaps:52,rating:4.9,rev:48,saved:[],isSquad:true,wants:["Food & Farming","Goods & Resale"],platforms:[{id:"instagram",l:"Instagram",proof:"Community circle · 2.4k",url:"instagram.com/northsidecircle"}],certs:[],taxBracket:"$0–$44k"},
  {id:22,uid:31,name:"Hank & June",ini:"HJ",avc:ac(5),type:"experience",cat:"Big-Ticket & Experiences",sub:"Property / stay nights",title:"2 nights at our Smoky Mountains cabin",desc:"Sleeps 6, hot tub, mountain views. Trade for home reno, photography, or a stay at your place.",rate:140,loc:"Gatlinburg, TN",remote:false,verified:true,elite:true,b2b:false,score:91,swaps:11,rating:5.0,rev:19,saved:[],wants:["Home & Trade Services","Creative & Design","Auto & Transportation"],platforms:[{id:"google",l:"Google Business",proof:"19 reviews · 5.0★",url:"g.co/smokycabin"},{id:"instagram",l:"Instagram",proof:"6.7k followers",url:"instagram.com/smokycabin"}],certs:[],taxBracket:"$95k–$201k"},
  {id:23,uid:32,name:"Zoe Min",ini:"ZM",avc:ac(6),type:"digital",cat:"Digital & Virtual",sub:"Shoutouts & ad swaps",title:"Social growth, UGC & creator shoutout swaps",desc:"140k combined following. UGC content + shoutout swaps for small brands. Trade for product or services.",rate:70,loc:"Remote",remote:true,verified:true,elite:false,b2b:false,score:85,swaps:38,rating:4.8,rev:64,saved:[],wants:["Beauty & Wellness","Food & Farming","Creative & Design"],platforms:[{id:"instagram",l:"Instagram",proof:"94k followers",url:"instagram.com/zoemin"},{id:"youtube",l:"YouTube",proof:"46k subscribers",url:"youtube.com/zoemin"}],certs:[],taxBracket:"$44k–$95k"},
  {id:24,uid:33,name:"Jay Okafor",ini:"JO",avc:ac(7),type:"goods",cat:"Goods & Resale",sub:"Clothing, shoes & sneakers",title:"Deadstock sneaker collection — open to trades",desc:"Verified kicks, DS & VNDS. Trade for tech, gear, or digital products. StockX-authenticated.",rate:75,loc:"Chicago, IL",remote:false,verified:true,elite:false,b2b:false,score:80,swaps:44,rating:4.9,rev:71,saved:[],wants:["Tech & Digital","Digital & Virtual","Goods & Resale"],platforms:[{id:"ebay",l:"eBay",proof:"300+ sales · 99.8%",url:"ebay.com/usr/jayo"},{id:"poshmark",l:"Poshmark",proof:"Posh Ambassador",url:"poshmark.com/jayo"}],certs:[],taxBracket:"$0–$44k"},
];
...
// ── HELPERS ──────────────────────────────────────────────────────────────────
// Brand logo. Swap the asset at public/logo.svg for the real one (any height works).
function Logo({ height = 28, style = {}, onClick }) {
  return <img src="/logo.svg?v=2" alt="BarterThat" onClick={onClick} style={{ height, width: "auto", display: "block", ...style }} />;
}
...
function Match({ listings, user, onView, onPropose }) {
  const [offer, setOffer] = useState(user?.cat || "Creative & Design");
  const [wants, setWants] = useState(user?.wants?.length ? user.wants : ["Beauty & Wellness", "Tech & Digital"]);
...
function Community({ listings, user, onView, onPropose, onNav }) {
  ...
  return (
    <div style={{ padding: "14px 14px 90px" }}>
      ...
      <Section title="◆ Talent & Ventures" sub="Find a co-founder, CTO, advisor, or pitch help — trade equity or skills" items={ventures} color="var(--pu)" />
...
export default function App() {
  ...
  const handleSignup = form => {
    ...
    if (form.title) {
      const nl = { id: Date.now() + 1, uid: u.id, type: catMeta?.t || "service", name: u.name, ini: u.ini, avc: u.avc, cat: form.cat || "Creative & Design", sub: form.sub, title: form.title, desc: form.desc, rate: form.rate, loc: form.loc, remote: true, verified: form.platforms.length >= 1, elite: false, b2b: form.b2b, score: 72, swaps: 0, rating: 0, rev: 0, saved: [], wants: form.wants || [], badges: form.badges || [], specialties: form.specialties || [], platforms: form.platforms, certs: form.certs, taxBracket: form.taxBracket };
      setListings(p => [nl, ...p]);
    }
    persist(u);
    setScreen("main");
